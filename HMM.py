# -*- coding: utf-8 -*-
"""
Created on Sun Jun  7 19:46:13 2020
...
#data_ = data_[(data_.index > "2018-03-08") & (data_.index < "2018-06-04")]
...
class StockPredictor(object):
    ...
    def predict_close_prices_for_days(self, days, with_plot=False):
        ...
        if with_plot:
            ...
            plt.plot(days, actual_close_prices, '-', label="actual")
...
stock_predictor = StockPredictor(data=data_)
stock_predictor.fit()
